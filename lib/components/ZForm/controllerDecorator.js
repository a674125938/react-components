...
var controllerDecorator = function controllerDecorator(options) {
  (0, _newArrowCheck2.default)(this, _this);
  return function decorator(Controller) {
    var _class, _temp;

    return _temp = _class = /*#__PURE__*/function (_Component) {
      (0, _inherits2.default)(WrappedController, _Component);

      var _super = _createSuper(WrappedController);

      function WrappedController() {
        (0, _classCallCheck2.default)(this, WrappedController);
        return _super.apply(this, arguments);
      }

      (0, _createClass2.default)(WrappedController, [{
        key: "render",
      ...
      zName: _propTypes.default.string.isRequired,
      zOptions: _propTypes.default.any
    }, _temp;
  };
}.bind(void 0);

var _default = controllerDecorator;
