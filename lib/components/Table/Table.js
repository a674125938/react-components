...
var _localeConsumerDecorator = _interopRequireDefault(
    require('../../components/LocaleProvider/localeConsumerDecorator')
);
...
var uid = 0;
var Table =
    ((_dec = (0, _localeConsumerDecorator.default)({
        defaultLocale: _zh_CN.default,
        localeName: 'Table'
    })),
    _dec(
        (_class =
            ((_temp = _class2 = /*#__PURE__*/ (function (_Component) {
                ...
                function Table(_props) {
                        ...
                        (0, _each2.default)(
                            ...
                            function (filter, key) {
                                ...
                                if (
                                    ...
                                    filter.value == null ||
                                    !column.filter ||
                                    (column.filter.multiple && !filter.value.length)
                                ) {
                                    delete filters[key];
                                } else {
                        ...
                        if (v !== _this2.state.searchValue) {
                            _this2.setState({
                                pagination: _objectSpread(
                                    _objectSpread({}, _this2.state.pagination),
                                    {},
                                    {
                                        current: 1
                                    }
                    ...
                    _this2.handleConditionChange = function (stateCondition) {
                        ...
                        stateCondition = _objectSpread(
                            _objectSpread({}, (0, _pick2.default)(_this2.state, ['order', 'filters', 'searchValue'])),
                            stateCondition
                        );
                            ...
                            (0, _extends2.default)(
                                {
                                    ...
                                    onChange: function (value) {
                                        ...
                                        _this2.handleFilter(
                                            columnKey,
                                            value == null || (multiple && !value.length) ? null : value
                                        );
                    ...
                    _this2.handleFilter = function (key, value) {
                        ...
                        var finalFilters = _this2.mergeFilters(
                            _this2.state.filters,
                            _objectSpread(
                                _objectSpread({}, _this2.state.filtersFromProps),
                                {},
                    ...
                    _this2.flatDataSource = function () {
                        ...
                        var childrenName =
                            arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'children';
                        var result = [];
                    ...
                    _this2.getDataSource = function (filters) {
                        ...
                        var doFilter = function doFilter(dataSource, filter) {
                            ...
                            var dataIndex = columnInfo.dataIndex,
                                ...
                                handleFilter =
                                    _columnInfo$filter$ha === void 0
                                        ? function (value, record, filterValue, multiple) {
                        ...
                        _this2.setState(
                            ...
                            function () {
                                ...
                                _this2.onSelectedRowKeysChange(
                                    _objectSpread(_objectSpread({}, selectedRowKeyMap), extendSelectedRowKeyMap)
                                );
                            }.bind(this)
                        );
                    }.bind(this);
                    ...
                    _this2.handleSelectRecord = function (_ref5) {
                        ...
                        var _this2$state2 = _this2.state,
                            ...
                            indeterminateSelectedRowKeyMap = _this2$state2.indeterminateSelectedRowKeyMap,
                            flatDataSourceKeys = _this2$state2.flatDataSourceKeys;

                        if (rowSelection.multiple === false) {
                            _this2.onSelectedRowKeysChange((0, _defineProperty2.default)({}, key, true));
                        } else {
                            var nowSelectedRowKeyMap = _objectSpread(
                                _objectSpread({}, selectedRowKeyMap),
                                {},
                                (0, _defineProperty2.default)({}, key, checked)
                            );
                            ...
                            var _this2$initLinkageRow = _this2.initLinkageRowSelectionMap(
                            ...
                            var truthyKeys = Object.keys(mergeMap).filter(
                                function (key) {
                                    (0, _newArrowCheck2.default)(this, _this23);
                                    return Boolean(mergeMap[key]);
                                }.bind(this)
                            );
                            var parentSelectedRowKeys = truthyKeys.reduce(
                                function (p, key) {
                                    var _this24 = this;

                                    (0, _newArrowCheck2.default)(this, _this23);
                                    var record = flatDataSourceKeys.find(
                                        function (record) {
                                            (0, _newArrowCheck2.default)(this, _this24);
                                            return String(record.key) == String(key);
                                        }.bind(this)
                                    );
                                    var parentKeys = p.filter(
                                        function (x) {
                                            (0, _newArrowCheck2.default)(this, _this24);
                                ...
                                (0, _toConsumableArray2.default)(truthyKeys)
                            );
                    ...
                    _this2.flatDataSourceKeysForMap = function (_ref6) {
                        ...
                        function getKey(children) {
                            ...
                            return children.reduce(
                                function (p, item) {
                                    ...
                                    return [].concat(
                                        (0, _toConsumableArray2.default)(p),
                                        (0, _toConsumableArray2.default)(childrenKeys)
                                    );
                                }.bind(this),
                                []
                            );
                        ...
                        var cloneDataSource = (0, _toConsumableArray2.default)(dataSource).filter(
                            function (item) {
                                (0, _newArrowCheck2.default)(this, _this26);
                                return !!item;
                            }.bind(this)
                    ...
                    _this2.getColumns = function (dataSourceOfCurrentPage, filters) {
                        ...
                        var _this2$state3 = _this2.state,
                            ...
                            indeterminateSelectedRowKeyMap = _this2$state3.indeterminateSelectedRowKeyMap;
                        var cloneColumns = columns.map(
                        ...
                        var newColumns = cloneColumns.filter(
                            function (column) {
                                (0, _newArrowCheck2.default)(this, _this30);
                                var key = column.key;
                                ...
                                return _objectSpread(
                                    ...
                                    {},
                                    {
                                        title: /*#__PURE__*/ _react.default.createElement(
                                            ...
                                            _this2.renderFilter(column, filters[columnKey], index),
                                            _this2.renderOrder(
                                                order,
                                                columnKey,
                                                dataIndex,
                                                currentOrder && currentOrder.key === columnKey
                                                    ? currentOrder.state
                                                    : 'none'
                                            )
                                        )
                        ...
                        if (rowSelection) {
                            ...
                            var disableItems = rowSelection.getDisabledOfRow && _this2.initDisabledOfRow();

                            var linkageFlag = rowSelection.multiple !== false && rowSelection.linkage ? true : false;

                            if (rowSelection.getDisabledOfRow) {
                                enableDataSourceOfCurrentPage = (0, _filter2.default)(
                                    flatDataSourceOfCurrentPage,
                                    function (item) {
                                        (0, _newArrowCheck2.default)(this, _this30);
                                        return linkageFlag
                                            ? !disableItems.includes(item.key)
                                            : !rowSelection.getDisabledOfRow(item.record);
                                    }.bind(this)
                                );
                                enableDataSource = (0, _filter2.default)(
                                    flatDataSource,
                                    function (item) {
                                        (0, _newArrowCheck2.default)(this, _this30);
                                        return linkageFlag
                            ...
                            var selectedEnableDataSourceOfCurrentPage = (0, _filter2.default)(
                            ...
                            var selectedEnableDataSource = (0, _filter2.default)(
                                enableDataSource,
                                function (item) {
                                    (0, _newArrowCheck2.default)(this, _this30);
                                    return selectedRowKeyMap[item.key];
                            ...
                            var selectedEnableDataSourceOfCurrentPageCount =
                            ...
                            var selectedCount = (0, _filter2.default)(
                                selectedRowKeyMap,
                                function (v) {
                                    (0, _newArrowCheck2.default)(this, _this30);
                                    return v;
                            ...
                            var renderSelectedAllCheckbox = function renderSelectedAllCheckbox() {
                                ...
                                return /*#__PURE__*/ _react.default.createElement(_Checkbox.default, {
                                    ...
                                    onChange: function () {
                                        ...
                                        var enableKeysOfCurrentPage = enableDataSourceOfCurrentPage.map(
                                            function (item) {
                            ...
                            newColumns.unshift({
                                title:
                                    rowSelection.multiple === false
                                        ? null
                                        : rowSelection.selectedTip === false
                                        ...
                                        : /*#__PURE__*/ _react.default.createElement(
                                              _Tooltip.default,
                                              {
                                                  ...
                                                  popup: /*#__PURE__*/ _react.default.createElement(
                                                      'span',
                                                      null,
                                                      locale.selected,
                                                      ' ',
                                                      ...
                                                      /*#__PURE__*/ _react.default.createElement(
                                                          _style.CancelSelect,
                                                          {
                                                              onClick: function () {
                                                                  ...
                                                                  (0, _newArrowCheck2.default)(this, _this30);
                                                                  var enableKeys = selectedEnableDataSource.map(
                                                                      function (item) {
                                                  ...
                                                  placement:
                                                      rowSelection.selectedTip === 'bottom' ? 'bottomLeft' : 'topLeft',
                                                  align: {
                                                      offset: [-8, 0]
                                                  }
                                              },
                        ...
                        if (columnPlaceholder) {
                            var lastUnFixedIndex = (0, _findLastIndex2.default)(
                                newColumns,
                    ...
                    _this2.setDragOver = function (source, target) {
                        ...
                        if (targetIndex >= 0) {
                            ...
                            (_this2$getRowDomByInd = _this2.getRowDomByIndex(targetIndex)) === null ||
                            _this2$getRowDomByInd === void 0
                                ? void 0
                                : _this2$getRowDomByInd.classList.add(_style.dragOverDownCls);
                        } else {
                    ...
                    _this2.unsetDragOver = function (source, target) {
                        ...
                        if (targetIndex >= 0) {
                            ...
                            (_this2$getRowDomByInd2 = _this2.getRowDomByIndex(targetIndex)) === null ||
                            _this2$getRowDomByInd2 === void 0
                                ? void 0
                                : _this2$getRowDomByInd2.classList.remove(_style.dragOverDownCls);
                        } else {
                    ...
                    _this2.onDrop = function (source, target) {
                        ...
                        dragSorting === null || dragSorting === void 0
                            ? void 0
                    ...
                    _this2.renderSearchInfo = function (option) {
                        ...
                        var renderLabel = function renderLabel(_ref7) {
                            ...
                            if (multiple) {
                                var label = (0, _map2.default)(
                                    value,
                                    function (v) {
                                        var _this38 = this;

                                        (0, _newArrowCheck2.default)(this, _this37);
                                        var option = (0, _find2.default)(
                                            options,
                                            function (option) {
                        ...
                        return !(0, _isEmpty2.default)(filters) || searchValue
                            ? /*#__PURE__*/ _react.default.createElement(
                                  'div',
                                  {
                                      key: 'search-info',
                    ...
                    _this2.renderTitle = function (option) {
                        ...
                        return [
                            ...
                            _this2.renderSearchInfo(option)
                        ];
                    }.bind(this);
                    ...
                    _this2.renderFooter = function (option) {
                        ...
                        return /*#__PURE__*/ _react.default.createElement(
                            'div',
                            null,
                            _this2.renderEmptyAndErrorInfo(option)
                        );
                    }.bind(this);
                    ...
                    _this2.onRow = function (record, index) {
                        ...
                        return _objectSpread(
                            _objectSpread({}, onRow(record, index)),
                            {},
                            {
                                record: record,
                    ...
                    var _flatDataSourceKeys = _this2.flatDataSourceKeysForMap({
                        dataSource: _dataSource
                    });

                    _this2.state.flatDataSourceKeys = _flatDataSourceKeys;

                    if ((0, _isObject2.default)(_rowSelection)) {
                        if ('selectedRowKeys' in _rowSelection) {
                            (0, _each2.default)(
                                _rowSelection.selectedRowKeys,
                                function (key) {
                                    (0, _newArrowCheck2.default)(this, _this3);
                            ...
                            (0, _each2.default)(
                                _rowSelection.defaultSelectedRowKeys,
                                function (key) {
                                    (0, _newArrowCheck2.default)(this, _this3);
                                    return (_selectedRowKeyMap[key] = true);
                                }.bind(this)
                        ...
                        if (_rowSelection.multiple !== false && _rowSelection.linkage) {
                            var _Object$keys$reduce = Object.keys(_selectedRowKeyMap).reduce(
                                    function (p, key) {
                                        (0, _newArrowCheck2.default)(this, _this3);

                                        var _this2$initLinkageRow2 = _this2.initLinkageRowSelectionMap(
                                                _selectedRowKeyMap,
                                                true,
                                                key,
                                                _flatDataSourceKeys,
                                                _this2.state.indeterminateSelectedRowKeyMap
                                            ),
                                        ...
                                        return {
                                            ...
                                            finalIndeterminate: _objectSpread(
                                                _objectSpread({}, p.finalIndeterminate),
                                                indeterminate
                                            )
                                        };
                                    }.bind(this),
                            ...
                            Object.keys(finalMergeMap).forEach(
                                function (key) {
                                    (0, _newArrowCheck2.default)(this, _this3);
                                    _selectedRowKeyMap[key] = finalMergeMap[key];
                                }.bind(this)
                            );
                            _this2.state.indeterminateSelectedRowKeyMap = _objectSpread({}, finalIndeterminate);
                        }
                    } // init order
                ...
                (0, _createClass2.default)(Table, [
                    {
                        ...
                        value: function initLinkageRowSelectionMap(
                            ...
                            function changeParentChecked(record, checked) {
                                ...
                                var mergeMap = _objectSpread(
                                    _objectSpread(_objectSpread({}, nowSelectedRowKeyMap), parentKeyCheckedMap),
                    ...
                    },
                    {
                        ...
                        value: function initDisabledOfRow() {
                            var _this41 = this;

                            var rowSelection = this.props.rowSelection;
                            var flatDataSourceKeys = this.state.flatDataSourceKeys;
                            ...
                            needFilterData = (0, _filter2.default)(
                                needFilterData,
                                function (item) {
                            ...
                            function getDisabledOfRow(record) {
                            ...
                            var allDisableItems = needFilterData.reduce(
                                function (p, item) {
                                    (0, _newArrowCheck2.default)(this, _this41);
                                    var keys = getDisabledOfRow(item, []);
                                    return [].concat(
                                        (0, _toConsumableArray2.default)(keys),
                                        (0, _toConsumableArray2.default)(item.childrenKeys)
                                    );
                                }.bind(this),
                                []
                            );
                    ...
                    },
                    {
                        ...
                        value: function render() {
                            ...
                            var columns = this.getColumns(dataSource, finalFilters); // 默认展开所有行

                            var defaultExpandAllRowsProps = !defaultExpandAllRows
                                ? null
                                : function () {
                                      ...
                                      var _this$state$changedUn = this.state.changedUnExpandedRowKeys,
                                          changedUnExpandedRowKeys =
                                              _this$state$changedUn === void 0 ? {} : _this$state$changedUn;
                            ...
                            return /*#__PURE__*/ _react.default.createElement(
                                ...
                                /*#__PURE__*/ _react.default.createElement(
                                    _ContainerContext.InheritProvider,
                                    {
                                        value: {
                                                          ...
                                                          pagination,
                                                          {
                                                              ...
                                                              onPageSizeChange: function (current, pageSize) {
                                                                  ...
                                                                  pagination.onPageSizeChange &&
                                                                      pagination.onPageSizeChange(current, pageSize);
                                                              }.bind(this),
                                                              onAdvise: function (current, pageSize) {
                                                                  ...
                                                                  pagination.onAdvise &&
                                                                      pagination.onAdvise(current, pageSize);
                                                              }.bind(this)
                                                          }
                                                      )
                                                  )
            ...
            (_class2.propTypes = {
                 ...
                 */
                rowSelection: _propTypes.default.oneOfType([
                ...
                /** 拖拽排序 */
                dragSorting: _propTypes.default.oneOfType([
                    _propTypes.default.oneOf([true]),
                    _propTypes.default.shape({
                        fixed: _propTypes.default.bool,
